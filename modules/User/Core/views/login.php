            ...
            <section class="xa-card">
                ...
                <div class="xa-card-body">
                    ...
                    <div class="xa-actions">
                        ...
                        <a class="xa-btn xa-btn--email" id="xaBtnEmail" href="/user/login/email<?= $next ? ('?next=' . urlencode($next)) : '' ?>">
                        ...
                        <!-- Create account -->
                        <a class="xa-btn xa-btn--primary" id="xaBtnCreate" href="/user/register<?= $next ? ('?next=' . urlencode($next)) : '' ?>">
...
<script>
    (function() {
        function setHeaderH() {
            // on cible d'abord .softadastra-navbar .softadastra-header, sinon .softadastra-navbar
            var header =
